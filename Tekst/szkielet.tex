...
\usepackage[all]{hypcap}	% czasami hyperref le podaje \ref
...
%%%%%%%%TO~NALEZY UZUPELNIC%%%%%%%%%%%%%%%%
\def\temat{Hybrid classifier using fuzzy logic and rough sets- simulation
investigations}
\def\tematen{Hybrydowy klasyfikator wykorzystujący zbiory rozmyte i
przybliżone-badania symulacyjne}
...
\input{stronaTytulowaPolski.tex}
\newpage
\input{StreszczeniePolski.tex}
\newpage

\input{stronaTytulowa.tex}
\newpage
\input{Abstract.tex}
\newpage
\tableofcontents
...
\newpage
\input{00celPracy.tex}
\input{01wstep.tex}
\input{02algorytmy.tex}
\newpage\clearpage
\input{03environment.tex}
\input{04investigations.tex}
\newpage\clearpage
\input{05conclusions.tex}
\newpage\clearpage
\input{06future_work.tex}
